...
import com.workspace.shopping.code.ShoppingInvoiceGeneratorUsingXml;
import com.workspace.shopping.code.ShoppingItem;


public class ShoppingInvoiceGeneratorUsingXmlTest {
private ShoppingInvoiceGeneratorUsingXml app;
	
	@Before
	public void setup() {
		this.app = new ShoppingInvoiceGeneratorUsingXml();
	}
	...
	public void readAllThreeXmlFilesandGenerateInvoice() {
		...
		try {
			invoiceDetails=app.parseShoppingReletedXmlFiles(categoryFileName, discountSlabFileName,
